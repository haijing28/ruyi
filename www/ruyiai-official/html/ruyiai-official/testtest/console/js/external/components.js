...
$.Dan.alert = function(text,type,fn){
	...
	this.obj = 	$('<div class="alert alert-block alert-info fixedAlert" style="width:564px;height:38px;line-height:10px;border-radius:0;border:none;color:'+color+';background-color:'+backColor+';left: -moz-calc(50% - 282px);left: -webkit-calc(50% - 282px);left: -ms-calc(50% - 282px);left: -o-calc(50% - 282px);left: calc(50% - 282px);top:-10px;"><img src="'+imgSrc+'" style="position:relative;top:-4px;margin-right:15px;"><button class="close" data-act="hide" type="button" style="line-height:inherit;color:'+color+'">×</button><span style="position:relative;top:-3px;">' + text +'</span></div>');
	this.fn = fn;
}
$.Dan.alert.prototype = {
	myShow : function(){
